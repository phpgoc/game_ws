...
fn game_state_requires_the_maximum_available_group_count_when_following_n_cards() {
    for lead_len in 1..=4 {
        ...
        for held_group_count in 0..=lead_len + 2 {
            ...
            let mut follow_rules = rules(2);
            follow_rules.target_rank = TractorRank::THREE;
            let mut state = state_with_hands(follow_rules, Vec::new(), hands);
            state
                .play_cards(0, "p0".to_owned(), lead_cards.clone())
            ...
            if required_group_count > 0 {
                ...
                assert_eq!(
                    state
                        .play_cards(1, "p1".to_owned(), under_follow)
            ...
            state
                .play_cards(1, "p1".to_owned(), legal_follow)
